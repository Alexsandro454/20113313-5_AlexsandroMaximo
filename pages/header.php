...
<style>
    *{
    ...
    body {
      ...
      min-height: 100%;
      background-image: url(./img/logoDoceDelicia.png);
...
<nav class="navbar navbar-expand-lg navbar-dark bg-info">
  <img class="logo" src="./imagens/logo.jpg" width="200px"alt="Alexsandro desenvolvedor">
  <a class="navbar-brand" href="#">ALEXDEV</a>
